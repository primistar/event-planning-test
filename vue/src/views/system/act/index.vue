        ...
        <el-row :gutter="20">
            ...
            <el-col :span="24" :xs="24">
                ...
                <el-row style="padding-bottom: 10px">
                    <el-button type="primary" icon="el-icon-new" size="mini" @click="createTemplate">新增活动</el-button>
                </el-row>
...
<script>
    ...
    import {addActivities, listActivities,listParticipant,applyParticipant,rejectParticipant} from "@/api/system/activities";
