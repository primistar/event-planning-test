    ...
    <div class="register">
        <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
            ...
            <el-form-item prop="username">
                <el-input v-model="registerForm.username" type="text" auto-complete="off" placeholder="请填入Email账号">
            ...
            <el-form-item prop="code" v-if="captchaEnabled">
                ...
                <div class="register-code">
                    <el-button :disabled="countdown > 0" type="primary" @click="sendEmailCode">{{ countdown > 0 ? `${countdown}秒后重新获取` :
                        '获取验证码' }}
                    </el-button>
            ...
            return {
                ...
                registerRules: {
                    username: [
                        ...
                        {min: 10, max: 20, message: '请填入正确的email账号', trigger: 'blur'},
                        {pattern: /^([a-zA-Z]|[0-9])(\w|\-)+@[a-zA-Z0-9]+\.([a-zA-Z]{2,4})$/, message: "请填入正确的email账号", trigger: "blur"}
        ...
        methods: {
            sendEmailCode() {
                if (!this.registerForm.username) {
                    this.$message.error("请正确填入email账号!");
                    return;
                }
                getEmailCode(this.registerForm.username).then(res => {
                    console.log(res);
                    this.$message.success("验证发送成功,请去邮箱中读取");
                }).catch(() => {
                    console.log('error');
                });
